...
# 科目过滤: 只下载匹配模式的文件 (正则匹配文件名)
# qp/Ms/Er/ir/in 全部下载，数字为卷号，最后一位为变体号
SUBJECT_FILTERS = {
    "0450": r"_(?:qp|ms|er|ir|in)_[12]\d",
    "0455": r"_(?:qp|ms|er|ir|in)_[12]\d",
    "0478": r"_(?:qp|ms|er|ir|in)_[12]\d",
    "0625": r"_(?:qp|ms|er|ir|in)_[246]\d",
    "0620": r"_(?:qp|ms|er|ir|in)_[246]\d",
    "9990": r"_(?:qp|ms|er|ir|in)_[1234]\d",
    "9868": r"_(?:qp|ms|er|ir|in)_[123]\d",
    "9609": r"_(?:qp|ms|er|ir|in)_[1234]\d",
    "9706": r"_(?:qp|ms|er|ir|in)_[1234]\d",
}
