...
DROP POLICY IF EXISTS "Teachers manage own class_papers" ON class_papers;
...
DROP POLICY IF EXISTS "Students read assigned papers" ON class_papers;
...
-- ============================================================
DROP POLICY IF EXISTS "Admins and teachers can update exam sessions" ON exam_sessions;
...
-- ============================================================
DROP POLICY IF EXISTS "Admins and teachers can insert papers" ON papers;
CREATE POLICY "Admins and teachers can insert papers" ON papers FOR INSERT
  WITH CHECK (current_user_role() IN ('admin', 'teacher'));

DROP POLICY IF EXISTS "Admins and teachers can update papers" ON papers;
CREATE POLICY "Admins and teachers can update papers" ON papers FOR UPDATE
  USING (current_user_role() IN ('admin', 'teacher'));

DROP POLICY IF EXISTS "Admins and teachers can delete papers" ON papers;
